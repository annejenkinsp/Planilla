...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-08-2018 a las 23:47:45
...
--
-- Estructura de tabla para la tabla `decimo`
--
...
--
-- Estructura de tabla para la tabla `noveno`
--
...
--
-- Estructura de tabla para la tabla `octavo`
--
...
--
-- Estructura de tabla para la tabla `septimo`
--

CREATE TABLE `septimo` (
  `#` int(2) NOT NULL,
  `Apellidos` varchar(300) NOT NULL,
  `Nombres` varchar(300) NOT NULL,
  `1` tinyint(1) NOT NULL,
...
--
-- Estructura de tabla para la tabla `sexto`
--
...
--
-- Estructura de tabla para la tabla `undecimo`
--

CREATE TABLE `undecimo` (
  `#` int(2) NOT NULL,
  `Apellidos` varchar(300) NOT NULL,
  `Nombres` varchar(300) NOT NULL,
  `1` tinyint(1) NOT NULL,
...
--
-- Indices de la tabla `decimo`
--
ALTER TABLE `decimo`
  ADD PRIMARY KEY (`#`);

--
-- Indices de la tabla `noveno`
--
ALTER TABLE `noveno`
  ADD PRIMARY KEY (`#`);

--
-- Indices de la tabla `octavo`
--
ALTER TABLE `octavo`
  ADD PRIMARY KEY (`#`);
...
--
-- Indices de la tabla `septimo`
--
ALTER TABLE `septimo`
  ADD PRIMARY KEY (`#`);

--
-- Indices de la tabla `sexto`
--
ALTER TABLE `sexto`
  ADD PRIMARY KEY (`#`);
...
--
-- Indices de la tabla `undecimo`
--
ALTER TABLE `undecimo`
  ADD PRIMARY KEY (`#`);
COMMIT;
